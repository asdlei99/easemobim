 ...
 * 评论和赞功能的演示页面
 */
public class FurmActivity extends Activity implements Callback, OnClickListener {
    // 模拟的主题id
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_furm);
        context = FurmActivity.this;
        ShareSDK.initSDK(this);
        ShareSDK.registerService(Socialization.class);

        new Thread() {
            public void run() {
                UIHandler.sendEmptyMessageDelayed(INIT_SDK, 100, FurmActivity.this);
            }
        }.start();
        ...
        Socialization.setLikeListener(new LikeListener() {
            ...
            public void onSuccess(String topicId, String topicTitle, String commentId) {
                ...
                msg.what = AFTER_LIKE;
                msg.arg1 = 1;
                UIHandler.sendMessage(msg, FurmActivity.this);
            }
    ...
    public boolean handleMessage(Message msg) {
        switch (msg.what) {
            case INIT_SDK:
                topicId = "ssdk20131220190000";
                topicTitle = "ShareSDK“评论与赞”模块发布";
                topicPublishTime = "2013-12-20 19:00";
                topicAuthor = "ShareSDK";
    ...
    private void initOnekeyShare() {
        ...
        oks.setText("ShareSDK for Android不仅集成简单、支持如QQ好友、微信、新浪微博、腾讯微博等所有社交平台，而且还有强大的统计分析管理后台，实时了解用户、信息流、回流率、传播效应等数据，详情见官网http://mob.com @ShareSDK");
        ...
        oks.setShareContentCustomizeCallback(new ShareContentCustomizeCallback() {
            public void onShare(Platform platform, ShareParams paramsToShare) {
                ...
                if ("Twitter".equals(platform.getName())) {
                    paramsToShare.setText("ShareSDK不仅集成简单、支持如微信、新浪微博、腾讯微博等社交平台，而且还有强大的统计分析管理后台，实时了解用户、信息流、回流率、传播效应等数据，详情见官网http://mob.com @ShareSDK");
                }
            }
        });
    }
    ...
    private void initQuickCommentBar() {
        ...
        qcBar.setTextToShare("ShareSDK for Android不仅集成简单、支持如QQ好友、微信、新浪微博、腾讯微博等所有社交平台，而且还有强大的统计分析管理后台，实时了解用户、信息流、回流率、传播效应等数据，详情见官网http://mob.com @ShareSDK");
